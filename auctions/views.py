...
def user_profile(request):
    ...
    user = request.user
    items = user.owner.filter(is_active=False)
    sales = user.owner.filter(is_active=True)
    return render(request, "auctions/user_profile.html", {"user": user, "items": items, "sales": sales})
